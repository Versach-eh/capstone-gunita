...
import 'package:gunita20/services/firebase_service.dart';
  ...
  class PuzzleWidgetModerate extends StatefulWidget {
    PuzzleWidgetModerate({Key? key}) : super(key: key);

    @override
    _PuzzleWidgetModerateState createState() => _PuzzleWidgetModerateState();
  }



  class _PuzzleWidgetModerateState extends State<PuzzleWidgetModerate> {
...
class _JigsawWidgetState extends State<JigsawWidget> {
  ...
  GlobalKey _globalKey = GlobalKey();
   ...
   // Define the key to access the _PuzzleWidgetModerateState
  GlobalKey<_PuzzleWidgetModerateState> _puzzleKey = GlobalKey<_PuzzleWidgetModerateState>(); 
...
resetJigsaw() {
  ...
  @override
  Widget build(BuildContext context) {
    _PuzzleWidgetModerateState? puzzleState =
        _puzzleKey.currentState as _PuzzleWidgetModerateState?;
