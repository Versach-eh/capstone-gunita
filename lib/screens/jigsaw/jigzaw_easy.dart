...
import 'package:gunita20/services/firebase_service.dart';
  ...
  class PuzzleWidgetEasy extends StatefulWidget {
    PuzzleWidgetEasy({Key? key}) : super(key: key);

    @override
    _PuzzleWidgetEasyState createState() => _PuzzleWidgetEasyState();
  }



  class _PuzzleWidgetEasyState extends State<PuzzleWidgetEasy> {
...
class _JigsawWidgetState extends State<JigsawWidget> {
  ...
  GlobalKey _globalKey = GlobalKey();
   ...
   // Define the key to access the _PuzzleWidgetEasyState
  GlobalKey<_PuzzleWidgetEasyState> _puzzleKey = GlobalKey<_PuzzleWidgetEasyState>(); 
...
resetJigsaw() {
  ...
  @override
  Widget build(BuildContext context) {
    _PuzzleWidgetEasyState? puzzleState =
        _puzzleKey.currentState as _PuzzleWidgetEasyState?;
