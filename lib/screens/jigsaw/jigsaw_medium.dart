...
import 'package:gunita20/services/firebase_service.dart';
  ...
  class PuzzleWidgetMedium extends StatefulWidget {
    PuzzleWidgetMedium({Key? key}) : super(key: key);

    @override
    _PuzzleWidgetMediumState createState() => _PuzzleWidgetMediumState();
  }



  class _PuzzleWidgetMediumState extends State<PuzzleWidgetMedium> {
...
class _JigsawWidgetState extends State<JigsawWidget> {
  ...
  GlobalKey _globalKey = GlobalKey();
   ...
   // Define the key to access the _PuzzleWidgetMediumState
  GlobalKey<_PuzzleWidgetMediumState> _puzzleKey = GlobalKey<_PuzzleWidgetMediumState>(); 
...
resetJigsaw() {
  ...
  @override
  Widget build(BuildContext context) {
    _PuzzleWidgetMediumState? puzzleState =
        _puzzleKey.currentState as _PuzzleWidgetMediumState?;
