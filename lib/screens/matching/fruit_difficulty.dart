...
class FruitMatchingDifficultyScreen extends StatefulWidget {
  const FruitMatchingDifficultyScreen({Key? key}) : super(key: key);

  @override
  _FruitMatchingDifficultyScreenState createState() => _FruitMatchingDifficultyScreenState();
}

class _FruitMatchingDifficultyScreenState extends State<FruitMatchingDifficultyScreen> {
                  ...
                  child: ElevatedButton(
                    onPressed: () {
                      ...
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => FruitMemoryMatchPage(gameLevel: level['level']),
                        ),
                      );
                    },
