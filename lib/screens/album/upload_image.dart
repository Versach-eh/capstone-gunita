                  ...
                  children: [
                    ...
                    Column(
                      ...
                      children: [
                        ElevatedButton(
  onPressed: () {
    // Show pop-up menu with options
    showMenu(
      context: context,
      position: RelativeRect.fromLTRB(80, 250, 100, 100), // Adjust the position as needed
      items: [
        
        PopupMenuItem(
          child: Container(
            padding: EdgeInsets.only(bottom: 8), // Add padding for the bottom border
            decoration: BoxDecoration(
              border: Border(bottom: BorderSide(color: Colors.black)), // Add bottom border
            ),
            width: 260,
          child: ListTile(
            title: Text('Camera',
  ...
  // new pasted from working screen images
    ...
    Future<void> _cameraUploadImageToFirebase() async {
      final user = FirebaseAuth.instance.currentUser!;
