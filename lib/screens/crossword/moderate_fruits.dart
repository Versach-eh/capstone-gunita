...
class ModerateFruitsScreen extends StatefulWidget {
  const ModerateFruitsScreen(
  ...
  @override
  _ModerateFruitsScreenState createState() => _ModerateFruitsScreenState();
}

class _ModerateFruitsScreenState extends State<ModerateFruitsScreen> {
...
void _handleContainerTap(String word) {
    setState(() {
      if (selectedWords.contains(word)) {
        ...
        // Select the word if less than 5 words are selected
