...
class HardPetsScreen extends StatefulWidget {
  const HardPetsScreen(
  ...
  @override
  _HardPetsScreenState createState() => _HardPetsScreenState();
}

class _HardPetsScreenState extends State<HardPetsScreen> {
