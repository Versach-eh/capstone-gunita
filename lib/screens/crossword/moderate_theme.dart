...
import 'package:gunita20/screens/crossword/moderate_fruits.dart';
import 'package:gunita20/screens/crossword/moderate_pets.dart';
import 'package:gunita20/screens/crossword/moderate_vegie.dart';
...
class ModerateThemesMenuScreen extends StatefulWidget {
  const ModerateThemesMenuScreen({Key? key}) : super(key: key);

  @override
  _ModerateThemesMenuScreenState createState() => _ModerateThemesMenuScreenState();
}

class _ModerateThemesMenuScreenState extends State<ModerateThemesMenuScreen> {
                  ...
                  child: ElevatedButton(
                    ...
                    onPressed: () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => ModeratePetsScreen(
                            difficulty: 0,
                          ),
                        ),
                      );
                  ...
                  child: ElevatedButton(
                    onPressed: () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => ModerateFruitsScreen(
                            difficulty: 1,
                          ),
                        ),
                      );
                  ...
                  child: ElevatedButton(
                    onPressed: () {
                       Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => ModerateVegieScreen(
                            difficulty: 1,
                          ),
                        ),
                      );
