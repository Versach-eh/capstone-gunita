...
class WordSearchPuzzleGenerator {
  ...
  List<List<String>> generatePuzzle() {
    ...
    if (selectedWords.any((word) => !isWordPresent(word))) {
...
class ThemeWordSearchScreen extends StatefulWidget {
  final List<String> selectedWords;
  final int difficulty;

  const ThemeWordSearchScreen(
      {Key? key, required this.selectedWords, required this.difficulty})
      : super(key: key);

  @override
  _ThemeWordSearchScreenState createState() => _ThemeWordSearchScreenState();
}

class _ThemeWordSearchScreenState extends State<ThemeWordSearchScreen> {
  ...
  bool areAllWordsMatched() {
    return Set.from(widget.selectedWords)
  ...
  Future<void> addGameDataToFirestore() async {
    try {
      ...
      await FirebaseFirestore.instance
        ...
        "wordsPlayed": widget.selectedWords,
                  ...
                  ElevatedButton(
                    onPressed: () {
                      ...
                      Navigator.of(context).pushReplacement(MaterialPageRoute(
                          builder: (context) =>
                              CrosswordMenuScreen())); // Navigate to the GameLibraryScreen
                    },
                    style: ElevatedButton.styleFrom(
                      fixedSize: Size(225, 45),
                      primary: Color(0xfffcD63131),
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Row(
                          mainAxisAlignment: MainAxisAlignment.center,
                          children: [
                            for (String word in widget.selectedWords)
                              Container(
