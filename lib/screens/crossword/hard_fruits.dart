...
class HardFruitsScreen extends StatefulWidget {
  const HardFruitsScreen(
  ...
  @override
  _HardFruitsScreenState createState() => _HardFruitsScreenState();
}

class _HardFruitsScreenState extends State<HardFruitsScreen> {
...
void _handleContainerTap(String word) {
    setState(() {
      if (selectedWords.contains(word)) {
        ...
        // Select the word if less than 6 words are selected
