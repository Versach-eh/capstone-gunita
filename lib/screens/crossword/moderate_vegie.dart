...
class ModerateVegieScreen extends StatefulWidget {
  const ModerateVegieScreen(
  ...
  @override
  _ModerateVegieScreenState createState() => _ModerateVegieScreenState();
}

class _ModerateVegieScreenState extends State<ModerateVegieScreen> {
