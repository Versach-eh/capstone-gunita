...
class HardVegieScreen extends StatefulWidget {
  const HardVegieScreen(
  ...
  @override
  _HardVegieScreenState createState() => _HardVegieScreenState();
}

class _HardVegieScreenState extends State<HardVegieScreen> {
