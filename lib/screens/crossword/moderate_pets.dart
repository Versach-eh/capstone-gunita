...
class ModeratePetsScreen extends StatefulWidget {
  const ModeratePetsScreen(
  ...
  @override
  _ModeratePetsScreenState createState() => _ModeratePetsScreenState();
}

class _ModeratePetsScreenState extends State<ModeratePetsScreen> {
