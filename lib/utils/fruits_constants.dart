...
const List<Map<String, dynamic>> gameLevels = [
  {'title': 'Easy', 'level': 2, 'color': Colors.amberAccent},
  {'title': 'Medium', 'level': 4, 'color': Colors.blueAccent},
  {'title': 'Hard', 'level': 6, 'color': Colors.cyanAccent},
  
];

const String gameTitle = 'Pair Play';