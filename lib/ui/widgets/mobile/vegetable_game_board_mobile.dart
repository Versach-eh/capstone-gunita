...
import 'package:gunita20/models/vegetable_game.dart';
...
class VegetableGameBoardMobile extends StatefulWidget {
  const VegetableGameBoardMobile({
  ...
  @override
  State<VegetableGameBoardMobile> createState() => _VegetableGameBoardMobileState();
}

class _VegetableGameBoardMobileState extends State<VegetableGameBoardMobile> {
  late Timer timer =
