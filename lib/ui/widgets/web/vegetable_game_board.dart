...
class VegetableGameBoard extends StatefulWidget {
  const VegetableGameBoard({
  ...
  @override
  State<VegetableGameBoard> createState() => _VegetableGameBoardState();
}

class _VegetableGameBoardState extends State<VegetableGameBoard> {
